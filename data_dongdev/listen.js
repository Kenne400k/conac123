...
///////////////////////////////////////
// Hàm chuyển ngày dd/mm/yyyy -> mm/dd/yyyy (để Date.parse không sai)
...
if (
    ...
    try {
        thuebot = JSON.parse(
            fs.readFileSync(path.join(__dirname, '../modules/commands/cache/data/thuebot.json'), 'utf8')
        );
    } catch {
        thuebot = [];
    }
